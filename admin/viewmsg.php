                 ...
                 <form action="" method="post">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" readonly name="name" value="<?php echo $fm->formatDate($result['date']); ?>" class="medium" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
								<textarea class="tinymce" readonly name="" id="" ><?php echo $result['body']; ?></textarea>
                            </td>
                        </tr>
